...
void print_hex(unsigned char *data, unsigned char data_len)
{
	unsigned char i;
...
int main()
{
	...
	unsigned char *messages[] = {
		...
		(unsigned char *)"abc123def456ghi?",
		(unsigned char *)"loooooooooooooong string!"};

	unsigned char md2_expecteds[][16] = {
	...
	unsigned char md4_expecteds[][16] = {
	...
	unsigned char md5_expecteds[][16] = {
	...
	unsigned char md2_digest[16], md4_digest[16], md5_digest[16];
